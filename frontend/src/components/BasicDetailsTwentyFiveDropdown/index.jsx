...
const BasicDetailsTwentyFiveDropdown = (props) => {
  return (
    <>
...
BasicDetailsTwentyFiveDropdown.defaultProps = {
  selectbuildtool_One: "Select build tool",
  toolCounter: "Tool 5",
  toolCounter_One: "Tool 5",
  toolCounter_Two: "Tool 5",
  toolCounter_Three: "Tool 5",
  toolCounter_Four: "Tool 5",
};

export default BasicDetailsTwentyFiveDropdown;
