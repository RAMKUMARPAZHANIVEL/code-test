...
const BasicDetailsTwentySixPage = () => {
        ...
        <div className="flex md:flex-col flex-row gap-[24px] items-center justify-between max-w-[1256px] mx-[auto] md:px-[20px] w-[100%]">
          ...
          <div className="flex flex-1 flex-col items-center justify-start w-[100%]">
            ...
            <div className="flex md:flex-col flex-row gap-[24px] items-start justify-between mt-[20px] w-[100%]">
              <div className="flex sm:flex-1 flex-col gap-[8px] items-start justify-start md:mt-[0] mt-[6px] self-stretch sm:w-[100%] w-[auto]">
              ...
              <div className="flex sm:flex-1 flex-col gap-[8px] items-start justify-start mb-[6px] self-stretch sm:w-[100%] w-[auto]">
                <Text
                  className="font-semibold text-gray_300 text-left w-[auto]"
                  variant="body2"
                >
            ...
            <div className="flex items-center justify-start mt-[14px] w-[100%]">
              <div className="md:gap-[20px] gap-[24px] grid md:grid-cols-1 grid-cols-2 justify-center min-h-[auto] w-[100%]">
                <div className="flex flex-1 flex-col gap-[8px] items-start justify-start self-stretch w-[100%]">
                  ...
                  <SelectBox
                    ...
                    name="dropdown"
                    placeholder="Select server vims"
                    isSearchable={false}
                    isMulti={false}
                    indicator={
                      <Img
...
export default BasicDetailsTwentySixPage;
