...
const BasicDetailsTwentyEightDropdown2 = (props) => {
  return (
    <>
...
BasicDetailsTwentyEightDropdown2.defaultProps = {
  selectarchitect_One: "Select architecture",
  architectureCounter: "Architecture 5",
...
export default BasicDetailsTwentyEightDropdown2;
