...
import CapabilitiesOneColumnclose from "components/CapabilitiesOneColumnclose";
            ...
            <div className="bg-gray_900 flex flex-col gap-[16px] h-[89px] md:h-[auto] items-start justify-start max-w-[982px] mt-[48px] w-[100%]">
              ...
              <div className="flex items-start justify-start w-[100%]">
                <div className="flex flex-row gap-[12px] items-center justify-end w-[100%]">
                  ...
                  <Button  onClick={()=> navigate("/basicdetails")} className="bg-gradient  cursor-pointer flex-1 font-medium px-[12px] py-[10px] rounded-[4px] text-[14px] text-center text-gray_900 w-[100%]">
                    Next
                  </Button>
                </div>
              </div>
...
export default CapabilitiesOnePage;
