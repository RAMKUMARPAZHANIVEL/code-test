...
const BasicDetailsThirtySevenDropdown = (props) => {
  return (
    <>
...
BasicDetailsThirtySevenDropdown.defaultProps = {
  ...
  afganistan_Four: "Package Management 5",
};

export default BasicDetailsThirtySevenDropdown;
